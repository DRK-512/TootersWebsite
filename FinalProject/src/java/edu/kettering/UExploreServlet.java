 ...
 * @author root
 */
@WebServlet(name = "UExploreServlet", urlPatterns = {"/Uexplore"})
public class UExploreServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String RedirectURL = "/UExplore.jsp"; 
        ...
        try {
            ArrayList<UserFind> list = new UserFind().getUserList();
